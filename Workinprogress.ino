...
void highlightSelectedArea() {
    switch (selectedField) {
        case CHARGING_TIME1:
            ...
            break;
        case CHARGING_TIME2:
            tft.drawRect(320, 40, 93, 33, TFT_YELLOW);
            break;
        case HEATING_TIME1:
            tft.drawRect(190, 85, 93, 33, TFT_YELLOW);
            break;
        case HEATING_TIME2:
            tft.drawRect(320, 85, 93, 33, TFT_YELLOW);
            break;
...
void clearPreviousHighlight() {
  switch (selectedField) {
    case CHARGING_TIME1:
      ...
      break;
    case CHARGING_TIME2:
      tft.drawRect(320, 40, 93, 33, TFT_BLACK); // Clear charging time 2 highlight
      break;
    case HEATING_TIME1:
      tft.drawRect(190, 85, 93, 33, TFT_BLACK); // Clear heating time 1 highlight
      break;
    case HEATING_TIME2:
      tft.drawRect(320, 85, 93, 33, TFT_BLACK); // Clear heating time 2 highlight
      break;
    case TEMPERATURE_RANGE:
...
void updateSelectedArea() {
    switch (selectedField) {
        ...
        case CHARGING_TIME2:
            // Clear the area and redraw the updated time
            tft.fillRect(320, 40, 93, 33, TFT_BLACK);
            tft.setTextSize(3);
        ...
        case HEATING_TIME2:
            // Clear the area and redraw the updated time
            tft.fillRect(320, 85, 93, 33, TFT_BLACK);
            tft.setTextSize(3);
...
void printSettings() {
  ...
  if (selectedField == CHARGING_TIME1) {
    tft.drawRect(190, 40, 93, 33, TFT_YELLOW); // Highlight charging time
    }  else if (selectedField == CHARGING_TIME2){
        tft.drawRect(320, 40, 93, 33, TFT_YELLOW); // Highlight charging time
    }
  ...
  if (selectedField == HEATING_TIME1) {
    tft.drawRect(190, 85, 93, 33, TFT_YELLOW); // Highlight heating time
  } else if (selectedField == HEATING_TIME2){
        tft.drawRect(320, 85, 93, 33, TFT_YELLOW); // Highlight charging time
    }
